...
export async function seedFinanceMasterData(
  ...
  await db
    .insert(approvalAuthorityRules)
    .values([
      {
        id: 'approval-supplier-payment-level-1',
        transactionType: 'SUPPLIER_PAYMENT',
        amountFromBaseIdr: 0,
        amountToBaseIdr: 9_999_999,
      ...
      {
        id: 'approval-supplier-payment-level-2',
        transactionType: 'SUPPLIER_PAYMENT',
        amountFromBaseIdr: 10_000_000,
        amountToBaseIdr: 99_999_999,
        requiredRole: 'Finance Reviewer',
      ...
      {
        id: 'approval-supplier-payment-level-3',
        transactionType: 'SUPPLIER_PAYMENT',
        amountFromBaseIdr: 100_000_000,
        amountToBaseIdr: null,
  ...
  await db
    ...
    .values([
      ...
      },
      {
        id: 'coa-2500',
        accountCode: '2500',
        accountName: 'Accrued Operating Liabilities',
        accountType: 'LIABILITY',
        normalBalance: 'CREDIT',
        parentAccountId: null,
        isPostable: true,
  ...
  await db
    ...
    .values([
      {
        id: 'cash-bank-main',
        accountCode: 'BANK-IDR-MAIN',
        accountName: 'Main Operating Bank - IDR',
        accountType: 'BANK',
        currencyCode: 'IDR',
        glAccountId: 'coa-1000',
        isActive: true,
        createdAt: referenceNow,
        updatedAt: referenceNow
      },
      {
        id: 'cash-petty-main',
        accountCode: 'CASH-IDR-PETTY',
        accountName: 'Head Office Petty Cash',
        accountType: 'CASH',
        currencyCode: 'IDR',
        glAccountId: 'coa-1010',
        isActive: true,
        createdAt: referenceNow,
        updatedAt: referenceNow
      }
  ...
  await db
    ...
    .values([
      ...
      {
        id: 'hp-wmx-ground-services',
        supplierCode: 'GROUND_WMX_MOCK',
        supplierName: 'Wamena Ground Handling Mock',
        stationId: 'st-wmx',
        serviceType: 'BOTH',
        referenceRate: 1500000,
        currencyId: 'cur-idr',
        contactPerson: 'Ground Services Desk WMX',
        phone: '+62-812-0000-5003',
        isActive: true,
        createdAt: referenceNow,
        updatedAt: referenceNow
      }
  ...
  await db
    ...
    .values([
      ...
      {
        id: 'policy-station-handling-cost-v1',
        policyCode: 'STATION_HANDLING_COST_APPROVED_V1',
        policyName: 'Recognize Finance-approved station handling cost',
        sourceModule: 'FLIGHT_OPERATIONS',
        eventType: 'STATION_HANDLING_COST_APPROVED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5200',
        creditAccountId: 'coa-2500',
        treatment: 'OPERATING_EXPENSE_ACCRUAL',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify(['stationId', 'flightId']),
        priority: 10,
        effectiveFrom: context.date(-60),
        effectiveTo: null,
        approvalStatus: 'APPROVED',
      ...
      {
        id: 'policy-station-parking-cost-v1',
        policyCode: 'STATION_PARKING_COST_APPROVED_V1',
        policyName: 'Recognize Finance-approved station parking cost',
        sourceModule: 'FLIGHT_OPERATIONS',
        eventType: 'STATION_PARKING_COST_APPROVED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5300',
        creditAccountId: 'coa-2500',
        treatment: 'OPERATING_EXPENSE_ACCRUAL',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify(['stationId', 'flightId']),
      ...
      {
        id: 'policy-customer-invoice-tax-v1',
        policyCode: 'CUSTOMER_INVOICE_TAX_V1',
        policyName: 'Record customer invoice output tax receivable',
        sourceModule: 'FINANCE',
        eventType: 'CUSTOMER_INVOICE_TAX',
        productAccountingProfileId: null,
        debitAccountId: 'coa-1100',
        creditAccountId: 'coa-2100',
        treatment: 'OUTPUT_TAX',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify(['flightId']),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-customer-receipt-allocation-v1',
        policyCode: 'CUSTOMER_RECEIPT_ALLOCATION_V1',
        policyName: 'Allocate customer receipt against accounts receivable',
        sourceModule: 'FINANCE',
        eventType: 'CUSTOMER_RECEIPT_ALLOCATED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-1000',
        creditAccountId: 'coa-1100',
        treatment: 'AR_SETTLEMENT',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
        effectiveTo: null,
        approvalStatus: 'APPROVED',
      ...
      {
        id: 'policy-po-supplier-invoice-v1',
        policyCode: 'PO_SUPPLIER_INVOICE_GRNI_V1',
        policyName: 'Clear goods receipt clearing into accounts payable',
        sourceModule: 'FINANCE',
        eventType: 'PO_SUPPLIER_INVOICE_POSTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-2400',
        creditAccountId: 'coa-2000',
        treatment: 'GRNI_TO_AP',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-non-po-supplier-invoice-v1',
        policyCode: 'NON_PO_SUPPLIER_INVOICE_V1',
        policyName: 'Recognize non-PO operational expense payable',
        sourceModule: 'FINANCE',
        eventType: 'NON_PO_SUPPLIER_INVOICE_POSTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5500',
        creditAccountId: 'coa-2000',
        treatment: 'EXPENSE_TO_AP',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-supplier-payment-v1',
        policyCode: 'SUPPLIER_PAYMENT_V1',
        policyName: 'Settle accounts payable from cash or bank',
        sourceModule: 'FINANCE',
        eventType: 'SUPPLIER_PAYMENT_EXECUTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-2000',
        creditAccountId: 'coa-1000',
        treatment: 'AP_SETTLEMENT',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-fuel-cost-v1',
        policyCode: 'FUEL_COST_POSTED_V1',
        policyName: 'Recognize posted flight fuel cost accrual',
        sourceModule: 'FINANCE',
        eventType: 'FUEL_COST_POSTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5100',
        creditAccountId: 'coa-2500',
        treatment: 'OPERATING_EXPENSE_ACCRUAL',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify(['flightId', 'stationId']),
      ...
      {
        id: 'policy-mro-cost-v1',
        policyCode: 'MRO_COST_APPROVED_V1',
        policyName: 'Recognize approved maintenance service cost accrual',
        sourceModule: 'FINANCE',
        eventType: 'MRO_COST_APPROVED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5400',
        creditAccountId: 'coa-2500',
        treatment: 'OPERATING_EXPENSE_ACCRUAL',
      ...
      {
        id: 'policy-accrual-posted-v1',
        policyCode: 'FINANCE_ACCRUAL_POSTED_V1',
        policyName: 'Recognize approved operating accrual',
        sourceModule: 'FINANCE',
      ...
      {
        id: 'policy-prepayment-initial-v1',
        policyCode: 'FINANCE_PREPAYMENT_INITIAL_V1',
        policyName: 'Record cash-funded operating prepayment',
        sourceModule: 'FINANCE',
        eventType: 'PREPAYMENT_POSTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-1400',
        creditAccountId: 'coa-1000',
        treatment: 'PREPAYMENT_ASSET',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-prepayment-recognition-v1',
        policyCode: 'FINANCE_PREPAYMENT_RECOGNITION_V1',
        policyName: 'Recognize scheduled prepayment expense',
        sourceModule: 'FINANCE',
        eventType: 'PREPAYMENT_RECOGNIZED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5500',
        creditAccountId: 'coa-1400',
        treatment: 'PREPAYMENT_RECOGNITION',
        capitalizationCandidate: false,
        requiredDimensionsJson: JSON.stringify([]),
        priority: 10,
        effectiveFrom: context.date(-60),
      ...
      {
        id: 'policy-depreciation-v1',
        policyCode: 'FINANCE_DEPRECIATION_V1',
        policyName: 'Post scheduled asset depreciation',
        sourceModule: 'FINANCE',
        eventType: 'DEPRECIATION_POSTED',
        productAccountingProfileId: null,
        debitAccountId: 'coa-5600',
        creditAccountId: 'coa-1500',
