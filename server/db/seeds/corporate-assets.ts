  ...
  const seed = sqlite.transaction(() => {
    ...
    for (const asset of [
      ...
      },
      {
        id: 'asset-gse-gpu-02',
        assetCode: 'GSE-00002',
        name: 'Ground Power Unit GPU-02',
        category: 'GSE',
        brand: 'ITW GSE',
        model: 'GPU-90',
        serialNumber: 'AMA-GPU-0002',
        stationId: 'st-djj',
        locationType: 'STATION',
        locationDetail: 'DJJ GSE Bay B',
        departmentId: 'dept-ops',
        currentCustodianEmployeeId: 'emp-rangga',
        custodianNameSnapshot: 'Rangga Wibowo',
        acquisitionDate: '2024-04-01',
        acquisitionReference: 'PO-GSE-2024-004',
        lifecycleStatus: 'ACTIVE',
        conditionStatus: 'SERVICEABLE',
        version: 1
      },
      {
        id: 'asset-gse-towbar-01',
        assetCode: 'GSE-00003',
        name: 'C208 Towbar-01',
        category: 'GSE',
        brand: 'Tronair',
        model: 'Towbar C208',
        serialNumber: 'AMA-TOWBAR-0001',
        stationId: 'st-djj',
        locationType: 'STATION',
        locationDetail: 'DJJ GSE Store',
        departmentId: 'dept-ops',
        currentCustodianEmployeeId: 'emp-rangga',
        custodianNameSnapshot: 'Rangga Wibowo',
        acquisitionDate: '2024-05-12',
        acquisitionReference: 'PO-GSE-2024-011',
        lifecycleStatus: 'ACTIVE',
        conditionStatus: 'SERVICEABLE',
        version: 1
      },
    ...
    insert(sqlite, 'asset_audits', {
      ...
      stationIdSnapshot: 'st-wmx',
      locationSnapshot: 'WMX Vehicle Pool',
      conditionSnapshot: 'LIMITED',
