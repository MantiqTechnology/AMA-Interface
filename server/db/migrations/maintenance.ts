export const maintenanceStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS maintenance_quality_findings (
    id TEXT PRIMARY KEY,
    reference TEXT NOT NULL UNIQUE,
    source_type TEXT NOT NULL,
    source_id TEXT NOT NULL,
    aircraft_id TEXT REFERENCES aircraft(id),
    work_package_id TEXT REFERENCES maintenance_work_packages(id),
    classification TEXT NOT NULL,
    description TEXT NOT NULL,
    status TEXT NOT NULL CHECK (status IN ('OPEN', 'UNDER_REVIEW', 'ACTION_REQUIRED', 'COMPLETED', 'CLOSED')),
    owner TEXT NOT NULL,
    due_date TEXT,
    fictional_demo INTEGER NOT NULL DEFAULT 1 CHECK (fictional_demo IN (0, 1)),
    created_at TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS maintenance_capa_actions (
    id TEXT PRIMARY KEY,
    finding_id TEXT NOT NULL REFERENCES maintenance_quality_findings(id),
  ...
  `CREATE TABLE IF NOT EXISTS maintenance_sdr_assessments (
    id TEXT PRIMARY KEY,
    source_type TEXT NOT NULL,
    source_id TEXT NOT NULL,
    reportability_status TEXT NOT NULL,
    discovered_at TEXT NOT NULL,
    simulated_due_at TEXT,
  ...
  `CREATE INDEX IF NOT EXISTS idx_mro_quality_findings_package ON maintenance_quality_findings(work_package_id, status)`,
...
export const maintenanceDropStatements = [
  ...
  'DROP TABLE IF EXISTS maintenance_sdr_assessments',
  'DROP TABLE IF EXISTS maintenance_capa_actions',
  'DROP TABLE IF EXISTS maintenance_quality_findings',
