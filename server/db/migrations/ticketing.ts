export const ticketingStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS passenger_tickets (
    ...
    source_rate_version INTEGER,
    rate_code_snapshot TEXT,
    currency_snapshot TEXT,
    base_rate_snapshot INTEGER,
    minimum_charge_snapshot INTEGER,
    rate_unit_snapshot TEXT,
    price_basis_snapshot TEXT,
    tax_rule_snapshot TEXT,
    pricing_scope_snapshot TEXT,
    calculation_lines_snapshot TEXT,
