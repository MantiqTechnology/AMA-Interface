...
export const passengerTickets = sqliteTable(
  'passenger_tickets',
  {
    ...
    sourceRateVersion: integer('source_rate_version'),
    rateCodeSnapshot: text('rate_code_snapshot'),
    currencySnapshot: text('currency_snapshot'),
    baseRateSnapshot: integer('base_rate_snapshot'),
    minimumChargeSnapshot: integer('minimum_charge_snapshot'),
    rateUnitSnapshot: text('rate_unit_snapshot'),
    priceBasisSnapshot: text('price_basis_snapshot'),
    taxRuleSnapshot: text('tax_rule_snapshot'),
    pricingScopeSnapshot: text('pricing_scope_snapshot'),
    calculationLinesSnapshot: text('calculation_lines_snapshot'),
    totalAmountSnapshot: integer('total_amount_snapshot'),
    ...
    agentCodeSnapshot: text('agent_code_snapshot'),
    ...
    commissionBasisType: text('commission_basis_type'),
    commissionBasisAmount: integer('commission_basis_amount'),
