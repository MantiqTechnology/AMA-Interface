...
export const flightVerificationEvidence = sqliteTable('flight_verification_evidence', {
  ...
  evidenceCategory: text('evidence_category').notNull().default('OPERATIONAL'),
  sourceParty: text('source_party'),
  sourcePartyName: text('source_party_name'),
  receivedAt: text('received_at'),
  receivedByStationId: text('received_by_station_id').references(() => stations.id),
