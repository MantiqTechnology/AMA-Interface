...
export const aircraftDefects = sqliteTable('aircraft_defects', {
  ...
  reporterObservation: text('reporter_observation').notNull().default('UNKNOWN'),
  initialSeverity: text('initial_severity').notNull().default('UNKNOWN'),
  operationalImpact: text('operational_impact'),
  flightPhase: text('flight_phase'),
...
export const aircraftDeferments = sqliteTable('aircraft_deferments', {
  ...
  targetRectificationAt: text('target_rectification_at'),
  effectiveAt: text('effective_at').notNull(),
  expiresAt: text('expires_at').notNull(),
  assessmentId: text('assessment_id'),
  followUpWorkPackageId: text('follow_up_work_package_id'),
