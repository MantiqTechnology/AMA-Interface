import {
  ...
  aircraftMaintenanceRequirementInputSchema
...
export default defineApiEventHandler(async (event) => {
  ...
  const body = await parseBody(event, aircraftMaintenanceRequirementInputSchema);
  return getServices().aircraftAirworthiness.addMaintenanceRequirement(id, body, {
