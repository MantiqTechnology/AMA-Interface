import { inventoryReorderRuleInputSchema } from '../../../../shared/features/inventory';
...
export default defineApiEventHandler(async (event) => {
  ...
  return getInventoryService().upsertReorderRule(
    await parseBody(event, inventoryReorderRuleInputSchema),
