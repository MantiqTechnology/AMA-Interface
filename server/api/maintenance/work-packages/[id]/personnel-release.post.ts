...
import { personnelActionSchema } from '#shared/features/maintenance-v21-schemas';
...
export default defineApiEventHandler(async (event) => {
  ...
  const body = await parseBody(event, personnelActionSchema);
  return getServices().resourceV21.releaseAssignment(
    body.assignmentId,
