  ...
  <VContainer fluid class="pb-0">
    ...
    <div class="mb-2">
      ...
      <div class="text-caption text-medium-emphasis">
        Pre-flight Risk Assessment & Fatigue Management
      </div>
    </div>
      ...
      <VCol cols="12" lg="4">
        <VCard border class="pa-4 h-100">
          <div class="text-subtitle-2 font-weight-bold mb-4">
            Flight Risk Matrix (Severity vs Likelihood)
          </div>
          <div class="d-flex align-stretch">
            <div
              class="d-flex flex-column justify-space-between mr-2 text-caption text-medium-emphasis pb-6 text-center"
            >
            ...
            <div class="flex-grow-1">
              <div class="d-flex flex-column ga-1">
                ...
                <div class="d-flex ga-1">
                  <div class="bg-success text-center py-2 flex-grow-1 font-weight-bold rounded-sm">
                    0
                  </div>
                  <div class="bg-success text-center py-2 flex-grow-1 font-weight-bold rounded-sm">
                    0
                  </div>
                  <div class="bg-warning text-center py-2 flex-grow-1 font-weight-bold rounded-sm">
                    1
                  </div>
                  <div
                    class="bg-error text-center py-2 flex-grow-1 font-weight-bold rounded-sm text-white"
                  >
                    1
                  </div>
                  <div
          ...
          <div class="text-caption text-medium-emphasis mt-4 italic">
            Klik pada sel matrix untuk melihat detail flight
          </div>
        </VCard>
      </VCol>
          ...
          <div class="d-flex align-center pa-3 border-b">
            ...
            >
              <VChip value="all" variant="outlined">
                All Flights <VBadge color="primary" content="24" inline class="ml-1" />
              </VChip>
              <VChip value="low" variant="outlined" class="text-success border-success">
                Low Risk <VBadge color="success" content="18" inline class="ml-1" />
              </VChip>
              <VChip value="medium" variant="outlined" class="text-warning border-warning">
                Medium Risk <VBadge color="warning" content="4" inline class="ml-1" />
              </VChip>
              <VChip value="high" variant="outlined" class="text-error border-error">
                High Risk <VBadge color="error" content="2" inline class="ml-1" />
              </VChip>
              <VChip value="blocked" variant="outlined">
                Blocked <VBadge color="error" content="1" inline class="ml-1" />
              </VChip>
              <VChip value="override" variant="outlined">
                Override <VBadge color="deep-purple-accent-1" content="1" inline class="ml-1" />
              </VChip>
            </VChipGroup>
            <VSpacer />
            <VBtn
          ...
          <VTable>
            ...
            <tbody>
              <tr v-for="flight in tableFlights" :key="flight.id">
                ...
                <td :class="['font-weight-bold text-center', textRiskColor(flight.risk)]">
                  {{ flight.score }}
                </td>
                <td>
                  <VChip
                    :color="riskColor(flight.risk)"
                    size="small"
                    variant="outlined"
                ...
                <td>
                  <VChip
                    :color="fatigueColor(flight.fatigue)"
                    size="small"
                    variant="tonal"
                ...
                <td>
                  <VChip
                    :color="fratStatusColor(flight.status)"
                    size="small"
                    variant="flat"
                    :class="flight.status === 'Released' ? 'text-white' : ''"
                  >
                    {{ flight.status }}
                  </VChip>
                </td>
      ...
      <VCol cols="12" lg="3">
        <VCard border class="pa-4 h-100">
          ...
          <div class="text-caption text-medium-emphasis mb-5">
            Wamena (WMX) – Mulia (MII)<br>21 Aug 2026 08:00 Local
          </div>
          ...
          <VRow dense class="mb-5">
            <VCol cols="6">
              <div class="border rounded pa-2 text-center h-100 d-flex flex-column justify-center">
                ...
                <div class="text-subtitle-1 font-weight-bold text-error">
                  6.7 <span class="text-caption text-medium-emphasis">/ 10</span>
                </div>
              </div>
            </VCol>
            <VCol cols="6">
            ...
            <VCol cols="6">
              <div class="border rounded pa-2 text-center h-100 d-flex flex-column justify-center">
                ...
                <div class="text-caption font-weight-bold text-deep-purple-accent-2">
                  Released (Override)
                </div>
              </div>
            </VCol>
...
const fratKpis = [
  {
    ...
    color: 'primary',
    trend: { icon: 'mdi-arrow-up-thin', text: '14% vs yesterday', tone: 'good' }
  },
  {
    title: 'FRAT Completed',
    value: '24',
  ...
  },
  {
    ...
    color: 'success',
    trend: { icon: 'mdi-arrow-down-thin', text: '2 vs yesterday', tone: 'good' }
  },
  {
    title: 'Medium Risk',
    value: '4',
    ...
    color: 'warning',
    trend: { icon: 'mdi-arrow-down-thin', text: '1 vs yesterday', tone: 'good' }
  },
  {
    title: 'High Risk',
    value: '2',
...
const fratTrend = {
  ...
  series: [{ name: 'Average Score', color: '#1E88E5', data: [5.1, 4.8, 5.6, 6.4, 6.1, 5.9, 6.2] }]
};
...
const tableFlights = [
  {
    id: 'AMA1263',
    datetime: '21 Aug 2026 07:15',
    station: 'Sentani (DJJ)',
    aircraft: 'DHC6-400 PK-AMA',
    route: 'DJJ - WMX',
    score: 4.2,
    risk: 'Low',
  ...
  {
    id: 'AMA1264',
    datetime: '21 Aug 2026 08:00',
    station: 'Wamena (WMX)',
    aircraft: 'DHC6-400 PK-AMB',
    route: 'WMX - MII',
    score: 6.7,
    risk: 'High',
  ...
  {
    id: 'AMA1265',
    datetime: '21 Aug 2026 09:30',
    station: 'Dekai (DKI)',
    aircraft: 'C208B PK-AMC',
    route: 'DKI - MUL',
    score: 3.8,
    risk: 'Medium',
    fatigue: 'Fit for Duty',
  ...
  {
    id: 'AMA1266',
    datetime: '21 Aug 2026 10:45',
    station: 'Timika (TIM)',
    aircraft: 'DHC6-400 PK-AMD',
    route: 'TIM - DJJ',
    score: 7.3,
    risk: 'High',
  ...
  {
    id: 'AMA1267',
    datetime: '21 Aug 2026 11:20',
    station: 'Mulia (MII)',
    aircraft: 'C208B PK-AME',
    route: 'MII - TIM',
    score: 2.9,
    risk: 'Low',
    fatigue: 'Fit for Duty',
  ...
  {
    id: 'AMA1268',
    datetime: '21 Aug 2026 13:05',
    station: 'Sentani (DJJ)',
    aircraft: 'DHC6-300 PK-AMF',
    route: 'DJJ - OKS',
    score: 5.1,
    risk: 'Medium',
    fatigue: 'Fatigue Elevated',
...
function textRiskColor(level: string) {
  return (
    { Low: 'text-success', Medium: 'text-warning', High: 'text-error', Blocked: 'text-error' }[
      level
    ] || 'text-grey'
  );
}
function fatigueColor(status: string) {
  return (
    { 'Fit for Duty': 'success', 'Fatigue Elevated': 'warning', 'Fatigue High': 'error' }[status] ||
    'grey'
  );
}
function fratStatusColor(status: string) {
  return (
    { Released: 'success', 'Released (Override)': 'deep-purple-accent-1', Blocked: 'error' }[
      status
    ] || 'grey'
  );
}
