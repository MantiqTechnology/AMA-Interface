  ...
  <VContainer fluid class="pb-0">
    ...
    <VCard border class="pa-3 mb-4">
      <div class="d-flex align-center flex-wrap ga-3">
        ...
        <VBtn variant="outlined" color="primary" density="compact" prepend-icon="mdi-refresh" class="text-none">
          Refresh
        </VBtn>
        <VBtn color="primary" density="compact" prepend-icon="mdi-pencil-plus-outline" class="text-none ml-2">
          New Publication
        </VBtn>
      </div>
    </VCard>
      ...
      <VCol cols="12">
        <VCard border class="pa-4 border-warning bg-orange-lighten-5">
          <div class="d-flex align-center mb-3">
            ...
            <VSpacer />
            <VBtn color="warning" variant="elevated" class="text-none font-weight-bold" prepend-icon="mdi-account-search">
              Review HRIS Log
            </VBtn>
          </div>
      ...
      <VCol cols="12" md="7">
        <VCard border class="pa-4 h-100">
          <div class="d-flex justify-space-between align-center mb-4">
            ...
            <VBtn size="small" variant="text" color="primary" class="text-none">Mark All as Read</VBtn>
          </div>
              ...
              <VListItem class="px-2 py-3 rounded hover-bg" :class="item.isUnread ? 'bg-blue-lighten-5' : ''">
                ...
                <template v-slot:append>
                  <div class="d-flex flex-column align-end justify-space-between h-100">
                    ...
                    <VBtn v-if="item.isUnread" size="small" color="primary" variant="flat" class="text-none px-2" height="24">
                      Read
                    </VBtn>
                    <VBtn v-else size="small" color="grey-darken-1" variant="outlined" class="text-none px-2" height="24">
                      View
                    </VBtn>
                  </div>
                </template>
      ...
      <VCol cols="12" md="5" class="d-flex flex-column ga-4">
        ...
        <VCard border class="pa-4 flex-grow-1">
          <div class="d-flex justify-space-between align-center mb-3">
            ...
            <VBtn size="small" color="primary" prepend-icon="mdi-plus" variant="tonal" class="text-none">New Minutes</VBtn>
          </div>
            ...
            <tbody>
              <tr v-for="meeting in meetings" :key="meeting.id" class="hover-bg">
                ...
                <td class="px-2 py-2 text-center">
                  ...
                  <div>
                    <VBtn icon="mdi-download-outline" variant="text" color="grey-darken-1" size="x-small" density="comfortable" />
                  </div>
                </td>
              </tr>
            </tbody>
...
const trainingAlerts = ref([
  { id: 1, name: 'Capt. Anton Wibowo', role: 'Pilot in Command', station: 'Sentani (DJJ)', course: 'Human Factors & SMS Training', expiry: '28 Aug 2026', daysLeft: 6 },
  { id: 2, name: 'Budi Santoso', role: 'MRO Technician', station: 'Wamena (WMX)', course: 'Dangerous Goods (DG) Awareness', expiry: '02 Sep 2026', daysLeft: 11 },
  { id: 3, name: 'Siti Aminah', role: 'FOO / Dispatcher', station: 'Timika (TIM)', course: 'Crew Resource Management (CRM)', expiry: '05 Sep 2026', daysLeft: 14 },
  { id: 4, name: 'Michael Hedy', role: 'Ground Handling', station: 'Dekai (DKI)', course: 'Apron Safety & Security', expiry: '12 Sep 2026', daysLeft: 21 }
])
...
const bulletins = ref([
  { 
    ...
    subtitle: 'Peringatan downdraft parah dan windshear di area approach WMX. Membutuhkan kewaspadaan ekstra saat final approach.', 
    author: 'Chief Pilot', 
    date: '21 Aug 2026', 
    icon: 'mdi-flash', 
    color: 'warning', 
  ...
  { 
    ...
    subtitle: 'Evaluasi insiden bird strike di Sentani (DJJ) pada penerbangan pagi hari. Penyesuaian prosedur takeoff saat musim migrasi burung.', 
  ...
  { 
    ...
    subtitle: 'Pembaruan prosedur komunikasi radio di area uncontrolled airspace pedalaman Papua sesuai arahan Airnav terbaru.', 
    author: 'Safety Dept', 
    date: '10 Aug 2026', 
  ...
  { 
    ...
    subtitle: 'Laporan indikasi kontaminasi air pada avtur dari drum suplai vendor lokal di airstrip perintis. Wajib SWD test sebelum fueling.', 
  ...
  { 
    ...
    subtitle: 'Pengingat keras penggunaan APD (Personal Protective Equipment) standar di seluruh area apron dan fasilitas MRO.', 
    author: 'Ground Ops', 
    date: '28 Jul 2026', 
    icon: 'mdi-hard-hat', 
    color: 'blue-grey', 
...
const meetings = ref([
  { id: 1, date: '12 Aug 2026', type: 'SAG - MRO', topics: 'Review defect deferral rate & GSE calibration issues', pending: '2 Open CAPA', pendingColor: 'warning' },
  { id: 2, date: '01 Aug 2026', type: 'SRB - Executive', topics: 'Q2 Safety Performance Review & SMS Budget Allocation', pending: 'Cleared', pendingColor: 'success' },
  { id: 3, date: '15 Jul 2026', type: 'SAG - Flight Ops', topics: 'Fatigue risk threshold adjustments for Papuan routes', pending: '1 Open CAPA', pendingColor: 'warning' },
  { id: 4, date: '05 Jul 2026', type: 'SAG - Ground Ops', topics: 'Dangerous Goods handling procedures in outstations', pending: 'Cleared', pendingColor: 'success' },
])
