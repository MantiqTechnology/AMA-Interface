...
import { stationsMasterDataConfig } from '#shared/contracts/master-data';
...
const config: MasterDataEntityConfig = stationsMasterDataConfig;
const ownerType = 'station' satisfies DocumentOwnerType;
