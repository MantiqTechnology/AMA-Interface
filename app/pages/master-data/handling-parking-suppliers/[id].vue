...
import { handlingParkingSuppliersMasterDataConfig } from '#shared/contracts/master-data';
...
const config: MasterDataEntityConfig = handlingParkingSuppliersMasterDataConfig;
