...
import { customersMasterDataConfig } from '#shared/contracts/master-data';
...
const config: MasterDataEntityConfig = customersMasterDataConfig;
const ownerType = 'customer' satisfies DocumentOwnerType;
