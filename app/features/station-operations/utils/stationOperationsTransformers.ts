...
export function buildDatasetFromApi(
  ...
  const services = flights
    ...
    .map((service) => ({
      ...
      creationSource: service.creationSource,
      completionRecord: service.completionRecord,
      completionEvidenceReference: service.completionEvidenceReference,
  ...
  const costs = flights
    ...
    .map((cost) => ({
      ...
      approvedAmount: cost.approvedAmount,
      approvedCurrencyCode: cost.approvedCurrencyCode,
      vendorReference: cost.vendorReference,
      evidenceReference: cost.evidenceReference,
      currencyCode: cost.currencyCode,
      submittedByUserId: cost.submittedByUserId,
      submittedAt: cost.submittedAt,
      approvedByUserId: cost.approvedByUserId,
      approvedAt: cost.approvedAt,
      financeHandoffId: cost.financeHandoffId,
      financeHandoffStatus: cost.financeHandoffStatus,
      accountingEventId: cost.accountingEventId,
      accountingEventStatus: cost.accountingEventStatus,
      journalEntryId: cost.journalEntryId,
      journalStatus: cost.journalStatus,
      postedLedgerAmount: cost.postedLedgerAmount,
      financialBasis: cost.financialBasis,
