...
export const purchaseRequisitions: PurchaseRequisition[] = [
  {
    ...
    items: [
      { name: 'Hydraulic seal kit', quantity: 12, unit: 'set', estimatedUnitPrice: 15_400_000 }
    ],
  ...
  },
  {
    ...
    items: [
      { name: 'Tug truck gearbox', quantity: 2, unit: 'unit', estimatedUnitPrice: 42_000_000 }
    ],
  ...
  },
  {
    ...
    items: [
      { name: 'Managed switch 24-port', quantity: 6, unit: 'unit', estimatedUnitPrice: 9_800_000 }
    ],
  ...
  },
  {
    ...
    items: [
      {
        name: 'Printer toner & stationery bundle',
        quantity: 1,
        unit: 'lot',
        estimatedUnitPrice: 21_500_000
      }
    ],
  ...
  },
  {
    ...
    items: [
      {
        name: 'Borescope inspection — CFM56',
        quantity: 1,
        unit: 'job',
        estimatedUnitPrice: 320_000_000
      }
    ],
...
export const sourcingEvents: SourcingEvent[] = [
  {
    ...
    quotations: [
      {
        vendor: 'PT Aero Parts Indonesia',
        quotedPrice: 640_000_000,
        leadTimeDays: 14,
        paymentTerms: 'Net 30',
        warranty: '12 months',
        documentCompliance: 'Complete',
        score: 93,
        selected: true
      },
      {
        vendor: 'PT Pacific Aviation Components',
        quotedPrice: 680_000_000,
        leadTimeDays: 21,
        paymentTerms: 'Net 30',
        warranty: '12 months',
        documentCompliance: 'Complete',
      ...
      {
        vendor: 'PT Global Aero Supply',
        quotedPrice: 710_000_000,
        leadTimeDays: 19,
        paymentTerms: 'Net 45',
        warranty: '6 months',
        documentCompliance: 'Partial',
        score: 78
      },
      {
        vendor: 'PT Garuda Engineering Supply',
        quotedPrice: 725_000_000,
        leadTimeDays: 18,
        paymentTerms: 'Net 30',
        warranty: '12 months',
        documentCompliance: 'Complete',
  ...
  },
  {
    ...
    quotations: [
      {
        vendor: 'PT Nusantara Ground Services',
        quotedPrice: 1_450_000_000,
        leadTimeDays: 30,
        paymentTerms: 'Net 30',
        warranty: '12 months',
        documentCompliance: 'Complete',
  ...
  },
  {
    ...
    quotations: [
      {
        vendor: 'PT Aviation Supply Nusantara',
        quotedPrice: 21_500_000,
        leadTimeDays: 6,
        paymentTerms: 'Net 30',
        warranty: '-',
        documentCompliance: 'Complete',
  ...
  },
  {
    ...
    quotations: [
      ...
      {
        vendor: 'PT Pertamina Aviation Partner',
        quotedPrice: 13_050_000_000,
        leadTimeDays: 7,
        paymentTerms: 'Net 21',
        warranty: '-',
        documentCompliance: 'Complete',
...
export const approvalQueue: ApprovalQueueItem[] = [
  {
    ...
    amount: 425_000_000,
    currentApprover: 'Finance Manager',
    waitingSince: '21 Aug 2026',
    waitingDays: 3,
    status: 'Pending'
  },
  {
    id: 'apq-002',
    reference: 'PO-AMA-260820-009',
    type: 'Purchase Order',
    requester: 'Deni Herlambang',
    amount: 210_000_000,
    currentApprover: 'Procurement Manager',
    waitingSince: '20 Aug 2026',
    waitingDays: 2,
    status: 'Pending'
  },
  {
  ...
  },
  {
    ...
    amount: 640_000_000,
    currentApprover: 'Procurement Manager',
    waitingSince: '19 Aug 2026',
    waitingDays: 4,
    status: 'Revision Required'
  },
  {
    id: 'apq-005',
    reference: 'PO-AMA-260818-009',
    type: 'Purchase Order',
    requester: 'Wahyu Nugroho',
    amount: 12_800_000_000,
    currentApprover: 'Direktur Operasional',
    waitingSince: '18 Aug 2026',
    waitingDays: 5,
    status: 'Pending'
  },
  {
    id: 'apq-006',
    reference: 'PR-AMA-260818-014',
    type: 'Purchase Requisition',
    requester: 'Andi Kurniawan',
    amount: 320_000_000,
    currentApprover: 'Finance Manager',
...
export const threeWayMatchRows: ThreeWayMatchRow[] = [
  ...
  },
  {
    ...
    supplier: 'PT Global Aero Supply',
    poAmount: 710_000_000,
    grAmount: 497_000_000,
    invoiceAmount: 497_000_000,
    status: 'Matched'
  },
  {
    id: 'twm-003',
    ...
    supplier: 'PT Garuda Engineering Supply',
    poAmount: 725_000_000,
    grAmount: 290_000_000,
    invoiceAmount: 305_000_000,
    status: 'Mismatch'
  },
  {
    id: 'twm-004',
    poNumber: 'PO-AMA-260812-004',
    grNumber: 'GR-AMA-260818-022',
    invoiceNumber: 'INV-2280',
    supplier: 'PT Aviation Supply Nusantara',
    poAmount: 21_500_000,
    grAmount: 21_500_000,
    invoiceAmount: 21_500_000,
    status: 'Matched'
  },
  {
    id: 'twm-005',
...
export const auditTrail: AuditLogEntry[] = [
  {
    timestamp: '22 Aug 2026 14:32',
    user: 'Andi Procurement',
  ...
  {
    timestamp: '20 Aug 2026 16:45',
    user: 'Rangga Wibowo',
    module: 'Sourcing',
    reference: 'RFQ-AMA-260819-006',
    action: 'Vendor Selected',
    previousValue: '-',
    newValue: 'PT Aero Parts Indonesia'
  },
  {
    timestamp: '19 Aug 2026 11:02',
    user: 'Dewi Lestari',
    module: 'Goods Receipt',
    reference: 'GR-AMA-260819-023',
    action: 'Inspection Completed',
    previousValue: 'Pending Inspection',
    newValue: 'Partially Accepted'
  },
  {
    timestamp: '18 Aug 2026 08:37',
    user: 'Bayu Saputra',
