  ...
  <VCard border class="pa-4 h-100 d-flex flex-column">
    ...
    <div class="d-flex align-center flex-grow-1">
      <div class="position-relative flex-shrink-0" style="width: 140px; height: 140px;">
        <VueApexCharts type="donut" width="140" height="140" :options="chartOptions" :series="series" />
        <div
      ...
      <div class="flex-grow-1 ml-4">
        <div v-for="seg in segments" :key="seg.label" class="d-flex align-center justify-space-between mb-2">
